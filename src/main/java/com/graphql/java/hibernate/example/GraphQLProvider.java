...
public class GraphQLProvider {
    ...
    private ChessWiring chessWiring;

    @Autowired
    public GraphQLProvider(StarWarsWiring starWarsWiring, ChessWiring chessWiring) {
        this.starWarsWiring = starWarsWiring;
        this.chessWiring = chessWiring;
    }
    ...
    private RuntimeWiring buildWiring() {
        return RuntimeWiring.newRuntimeWiring()
                .type(newTypeWiring("Query")
                        ...
                        .dataFetcher("game",chessWiring.chessDataFetcher)
                        .dataFetcher("games",chessWiring.gamesDataFetcher)
                )
